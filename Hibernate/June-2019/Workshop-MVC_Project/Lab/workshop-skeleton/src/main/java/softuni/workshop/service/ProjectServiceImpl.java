...
public class ProjectServiceImpl implements ProjectService {
    ...
    @Autowired
    public ProjectServiceImpl(ProjectRepository projectRepository, CompanyRepository companyRepository, FileUtil fileUtil, ValidatorUtil validatorUtil, XmlParser xmlParser, ModelMapper modelMapper) {
    ...
    public String readProjectsXmlFile() throws IOException {
        return this.fileUtil.readContent("projects");
    }
